...
extern "C" {
    ...
    bool onEntityInteractBlock(PluginInterface *interface, Entity *entity, Block *block);
    ...
    bool onBlockInteract(PluginInterface *interface, Block *block, Vector3<int> *position, Entity *entity);
